...
function VManip:RegisterAnim(arg1, arg2, arg3)
    ...
    local xData = {
        ...
        block_code = data.block_code or data.blockcode or data.stop_code or data.stopcode or data.block_execution or data.stop_execution or data.pause_code,
        block_code_scope = data.block_code_scope or data.code_block_scope or data.block_scope or data.scope,
